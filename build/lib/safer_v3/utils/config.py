...
class LPVSINDyConfig:
    ...
    Attributes:
        ...
        threshold: Sparsity threshold for STLSQ (higher = more sparse)
        ...
        use_adaptive_scheduling: Enable LPV mode with health-dependent scheduling
        nominal_egtm: Nominal EGT margin at start of life for scheduling
        min_egtm: Minimum EGT margin at end of life for scheduling
    """
    n_features: int = 14
    polynomial_degree: int = 2  # Renamed from poly_degree
    include_interactions: bool = True
    threshold: float = 0.5  # Increased from 0.1 for better sparsity (70-85%)
    alpha: float = 0.01
    ...
    use_adaptive_scheduling: bool = True  # Enable LPV mode with health-dependent terms
    nominal_egtm: float = 100.0  # EGT margin at start of life
    min_egtm: float = 0.0  # EGT margin at end of life
